...
const quiz = [
    ...
    , {
      ...
      answers: [ '年初に当年度分をまとめて工場原価で算出、付与', '年初に当年度分を製造部から申請、工場原価にて付与', '日々、予算係数・操業度に応じてシステムで自動付与', '前月時点の台数計画を基に、次月予算がシステムで自動付与'],
      correct: '日々、予算係数・操業度に応じてシステムで自動付与'
    }
    , {
      question: '直管費予算予算は係数×操業度で算出されるが、予算係数の説明として適切でないものはどれか',
      answers: [ '予算係数とは操業度当たりの使用量や金額のことであり、原単位管理の基準となる', '予算係数は品番別や機番別で設定される', '特別な事情が無い限り、期中での予算係数見直しは実施しない', 'どんな理由であれ予算に不足があった場合、予算係数を見直すことが出来る'],
      correct: 'どんな理由であれ予算に不足があった場合、予算係数を見直すことが出来る'
    }
  ];
